...
#define MODEL_FILE_TRASH    "/userdata/models/cnn_trash_classify/insect_classify_inst.wk" // Open source model conversion
#define MODEL2_FILE_TRASH    "/userdata/models/cnn_trash_classify/insect_classify_inst2.wk" // Open source model conversion
#define MODEL3_FILE_TRASH    "/userdata/models/cnn_trash_classify/insect_classify_inst3.wk" // Open source model conversion
#define MODEL4_FILE_TRASH    "/userdata/models/cnn_trash_classify/insect_classify_inst4.wk" // Open source model conversion
#define MODEL5_FILE_TRASH    "/userdata/models/cnn_trash_classify/insect_classify_inst5.wk" // Open source model conversion
#define MODEL6_FILE_TRASH    "/userdata/models/cnn_trash_classify/insect_classify_inst6.wk" // Open source model conversion
#define MODEL7_FILE_TRASH    "/userdata/models/cnn_trash_classify/insect_classify_inst7.wk" // Open source model conversion
#define MODEL8_FILE_TRASH    "/userdata/models/cnn_trash_classify/insect_classify_inst8.wk" // Open source model conversion
#define MODEL9_FILE_TRASH    "/userdata/models/cnn_trash_classify/insect_classify_inst9.wk" // Open source model conversion
#define MODEL10_FILE_TRASH    "/userdata/models/cnn_trash_classify/insect_classify_inst10.wk" // Open source model conversion
#define MODEL11_FILE_TRASH    "/userdata/models/cnn_trash_classify/insect_classify_inst11.wk" // Open source model conversion
#define MODEL12_FILE_TRASH    "/userdata/models/cnn_trash_classify/insect_classify_inst12.wk" // Open source model conversion
#define MODEL13_FILE_TRASH    "/userdata/models/cnn_trash_classify/insect_classify_inst13.wk" // Open source model conversion
#define MODEL14_FILE_TRASH    "/userdata/models/cnn_trash_classify/insect_classify_inst14.wk" // Open source model conversion
#define MODEL15_FILE_TRASH    "/userdata/models/cnn_trash_classify/insect_classify_inst15.wk" // Open source model conversion
#define MODEL16_FILE_TRASH    "/userdata/models/cnn_trash_classify/insect_classify_inst16.wk" // Open source model conversion
#define MODEL17_FILE_TRASH    "/userdata/models/cnn_trash_classify/insect_classify_inst17.wk" // Open source model conversion
#define MODEL18_FILE_TRASH    "/userdata/models/cnn_trash_classify/insect_classify_inst18.wk" // Open source model conversion
#define MODEL19_FILE_TRASH    "/userdata/models/cnn_trash_classify/insect_classify_inst19.wk" // Open source model conversion
#define MODEL20_FILE_TRASH    "/userdata/models/cnn_trash_classify/insect_classify_inst20.wk" // Open source model conversion
#define MODEL21_FILE_TRASH    "/userdata/models/cnn_trash_classify/insect_classify_inst21.wk" // Open source model conversion
#define MODEL22_FILE_TRASH    "/userdata/models/cnn_trash_classify/insect_classify_inst22.wk" // Open source model conversion
#define MODEL23_FILE_TRASH    "/userdata/models/cnn_trash_classify/insect_classify_inst23.wk" // Open source model conversion
#define MODEL24_FILE_TRASH    "/userdata/models/cnn_trash_classify/insect_classify_inst24.wk" // Open source model conversion
#define MODEL25_FILE_TRASH    "/userdata/models/cnn_trash_classify/insect_classify_inst25.wk" // Open source model conversion
#define MODEL26_FILE_TRASH    "/userdata/models/cnn_trash_classify/insect_classify_inst26.wk" // Open source model conversion
#define MODEL27_FILE_TRASH    "/userdata/models/cnn_trash_classify/insect_classify_inst27.wk" // Open source model conversion
#define MODEL28_FILE_TRASH    "/userdata/models/cnn_trash_classify/insect_classify_inst28.wk" // Open source model conversion
#define MODEL29_FILE_TRASH    "/userdata/models/cnn_trash_classify/insect_classify_inst29.wk" // Open source model conversion
#define MODEL30_FILE_TRASH    "/userdata/models/cnn_trash_classify/insect_classify_inst30.wk" // Open source model conversion
#define MODEL31_FILE_TRASH    "/userdata/models/cnn_trash_classify/insect_classify_inst31.wk" // Open source model conversion
#define MODEL32_FILE_TRASH    "/userdata/models/cnn_trash_classify/insect_classify_inst32.wk" // Open source model conversion
...
#define UNKNOWN_WASTE         4    // Unknown Waste
...
// BugNet
int alcidodes_confirmed_time = 0;
int alcidodes_confirmed_flag = 0;
int carab_confirmed_time = 0;
int carab_confirmed_flag = 0;
int locust_confirmed_time = 0;
int locust_confirmed_flag = 0;
int protaetia_confirmed_time = 0;
int protaetia_confirmed_flag = 0;
int bug_class = -1;
...
static HI_S32 CnnTrashClassifyFlag(const RecogNumInfo items[], HI_S32 itemNum, HI_CHAR* buf, HI_S32 size)
{
    ...
    for (HI_U32 i = 0; i < itemNum; i++) {
        ...
        {
            HTTP_Config();
            Upload_Image_Info(bug_class);
            bug_class = -1;  
        }
        switch (item->num) {
            case 0u:
                trashName = "Alcidodes";
                alcidodes_confirmed_time = alcidodes_confirmed_time + 1;
                if(alcidodes_confirmed_time == 1000)
                {
                    alcidodes_confirmed_time = 0;
                    carab_confirmed_time = 0;
                    locust_confirmed_time = 0;
                    protaetia_confirmed_time = 0;
                    // alcidodes_confirmed_flag = 1;
                    bug_class = 0;
                }
                break;
            case 1u:
                trashName = "Carab";
                carab_confirmed_time = carab_confirmed_time + 1;
                if(carab_confirmed_time == 1000)
                {
                    alcidodes_confirmed_time = 0;
                    carab_confirmed_time = 0;
                    locust_confirmed_time = 0;
                    protaetia_confirmed_time = 0;
                    // carab_confirmed_flag = 1;
                    bug_class = 1;
                }
                break;
            case 2u:
                trashName = "Locust";
                locust_confirmed_time = locust_confirmed_time + 1;
                if(locust_confirmed_time == 1000)
                {
                    alcidodes_confirmed_time = 0;
                    carab_confirmed_time = 0;
                    locust_confirmed_time = 0;
                    protaetia_confirmed_time = 0;
                    // locust_confirmed_flag = 1;
                    bug_class = 2;
                }
                break;
            case 3u:
                trashName = "Protaetia";
                protaetia_confirmed_time = protaetia_confirmed_time + 1;
                if(protaetia_confirmed_time == 1000)
                {
                    alcidodes_confirmed_time = 0;
                    carab_confirmed_time = 0;
                    locust_confirmed_time = 0;
                    protaetia_confirmed_time = 0;
                    // protaetia_confirmed_flag = 1;
                    bug_class = 3;
                }
                break;
            default:
